...
//    int const NUMBER_OF_ANGLES_SMALL = 32;
    ...
    float radius_Medium = 0.36f;
    float radius_arc=0.29f;
    float radius_Small=0.12f;
...
//   rectangle Left
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glDrawArrays(GL_TRIANGLE_FAN, 9 * (NUMBER_OF_ANGLES + 2)-3, 4);
        glDrawArrays(GL_TRIANGLE_FAN, 9 * (NUMBER_OF_ANGLES + 2)+1, 4);
        glDrawArrays(GL_TRIANGLE_FAN, 9 * (NUMBER_OF_ANGLES + 2)+5, 4);
