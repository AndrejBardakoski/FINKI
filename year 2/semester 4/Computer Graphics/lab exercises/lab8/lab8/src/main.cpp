...
int main() {
    ...
    Shader lightCubeShader(shader_location + lamp_shader + std::string(".vert"),
...
//    Shader lightCubeShader("4.4.light_cube.vs", "4.4.light_cube.fs");
    ...
    glm::vec3 cubePositions[] = {
            ...
            glm::vec3(-4.7f,  3.0f, 3.5f),
            glm::vec3( 5.3f, -2.0f, -6.5f),
    ...
    unsigned int emissionMap = loadTexture("../res/textures/matrix2.jpg");
