...
const std::string program_name = ("CheckerBoard textures 1");
...
int main() {
    ...
    float vertices[] = {
            ...
            0.0f, 0.8f, 0.0f, 1.0f, 0.0f, 0.0f, 0.5f, 1.0f, // top
    ...
    unsigned char *data = stbi_load(
            "D:\\fakultet\\2god\\4 semestar\\KG\\lab\\lab4\\zad1\\res\\textures\\Checkerboard_pattern.png",
